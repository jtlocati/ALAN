...
YMAL_DATA = Path("data/datasets/chips/data.yaml")
...
def main() -> None:
    ...
    model.train(
        ...
        migsz=640, hsv_h=0.0, hsv_s=0.4, hsv_v=0.4, degrees=180.0,fliplr=0.5, flipud=0.5, scale=0.4, mosaic=1.0, close_mosaic=15, mixup=0.0,
